...
class TestPlaygroundAppTest:
    ...
    def test_handle_incorrectly_selecting_multiple_projects(
        self, mocker: MockerFixture
    ) -> None:
        mocker.patch("dearpygui.dearpygui.split_frame")
        mocker.patch(
            "dearpygui.dearpygui.get_item_configuration",
            return_value={"width": 200, "height": 150},
        )
        ...
        app_data = {
            ...
            "selections": {
                "imaginary_project": "bogus/path",
                "another_fake_project": "bogus/path",
            },
        }

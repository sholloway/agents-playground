...
class TestFrustum2d:
    ...
    def test_intersect_aabb(self) -> None:
        ...
        """
        south_aabb: Polygon = AABBox2d(
            center=Vertex2d(50, 1), half_height=2, half_width=2
        )
        west_aabb: Polygon = AABBox2d(
            center=Vertex2d(1, 50), half_height=2, half_width=2
        )
        north_aabb: Polygon = AABBox2d(
            center=Vertex2d(50, 100), half_height=2, half_width=2
        )
        east_aabb: Polygon = AABBox2d(
            center=Vertex2d(100, 50), half_height=2, half_width=2
        )

        # at (50,50)
        frustum: Frustum = Frustum2d(
            near_plane_depth=10, depth_of_field=100, field_of_view=120
        )

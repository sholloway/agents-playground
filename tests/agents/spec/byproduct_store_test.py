...
from agents_playground.agents.spec.byproduct_store import (
...
class TestByproductStore:
    def test_register_for_unique_byproduct(self, mocker: MockerFixture) -> None:
        ...
        byproducts.register_subsystem_byproducts(
            "root-system", subsystem.name, subsystem.byproducts_definitions
        )

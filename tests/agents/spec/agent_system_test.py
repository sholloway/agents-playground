...
from agents_playground.agents.default.default_agent_system import (
    DefaultAgentSystem,
    SystemWithByproducts,
)
...
class TestAgentSystem:
    ...
    def test_registering_subsystems_with_byproducts(
        self, mocker: MockerFixture
    ) -> None:
        root_system = DefaultAgentSystem("root-system")
        subsystem_a = DefaultAgentSystem("subsystem_a")
        subsystem_b = SystemWithByproducts(
            "subsystem_b",
            [ByproductDefinition("a", int), ByproductDefinition("b", float)],
        )
        subsystem_c = SystemWithByproducts(
            "subsystem_c",
            [

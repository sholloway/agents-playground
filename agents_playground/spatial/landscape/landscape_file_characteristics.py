...
class LandscapeFileCharacteristics:
    ...
    creation_time: Maybe[DateTime] = (
        Nothing()
    )  # When the file was initially created in the format YYYY-MM-DD hh:mm:ss.micro
    updated_time: Maybe[DateTime] = (
        Nothing()
    )  # When the file was last updated in the format YYYY-MM-DD hh:mm:ss.micro

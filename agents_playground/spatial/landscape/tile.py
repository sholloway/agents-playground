...
TileCubicVerticesPlacement: dict[TileCubicPlacement, tuple[Vector, ...]] = {
    TileCubicPlacement.BOTTOM: (
        CubicVertexUnitVectors.F,
        CubicVertexUnitVectors.B,
        CubicVertexUnitVectors.C,
        CubicVertexUnitVectors.G,
    ),
    TileCubicPlacement.FRONT: (
        CubicVertexUnitVectors.D,
        CubicVertexUnitVectors.C,
        CubicVertexUnitVectors.B,
        CubicVertexUnitVectors.A,
    ),
    TileCubicPlacement.TOP: (
        CubicVertexUnitVectors.H,
        CubicVertexUnitVectors.D,
        CubicVertexUnitVectors.A,
        CubicVertexUnitVectors.E,
    ),
    TileCubicPlacement.LEFT: (
        CubicVertexUnitVectors.G,
        CubicVertexUnitVectors.C,
        CubicVertexUnitVectors.D,
        CubicVertexUnitVectors.H,
    ),
    TileCubicPlacement.BACK: (
        CubicVertexUnitVectors.E,
        CubicVertexUnitVectors.F,
        CubicVertexUnitVectors.G,
        CubicVertexUnitVectors.H,
    ),
    TileCubicPlacement.RIGHT: (
        CubicVertexUnitVectors.B,
        CubicVertexUnitVectors.F,
        CubicVertexUnitVectors.E,
        CubicVertexUnitVectors.A,

...
@deprecated(
    reason="This class is replaced by the MeshLike and MeshBuffer implementations."
)
class EdgeMesh:
    """
        ...
        for polygon in obj.polygons:
            ...
            if v1_normal_index is None:
                ...
                raise NotImplementedError(
                    "Obj files without vertex normals is currently not supported."
                )
            ...
            for index in range(1, len(polygon.vertices) - 1):
                ...
                edge_mesh.vertex_normals.extend(
                    (*v1_normal, *v2_normal, *v2_normal, *v3_normal, *v1_normal)
                )

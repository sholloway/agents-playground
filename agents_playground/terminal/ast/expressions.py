...
class ExprVisitor(ABC, Generic[VisitorResult]):
  @abstractmethod
  def visit_logical_expr(self, expression: LogicalExpr[VisitorResult]) -> VisitorResult:
  ...
  @abstractmethod
  def visit_literal_expr(self, expression: LiteralExpr[VisitorResult]) -> VisitorResult:

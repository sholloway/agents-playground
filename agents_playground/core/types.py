...
# Performance Related
type Sample = int | float

# Coordinates
# Note the definition of CanvasLocation is driven by DPGs annoying
# habit of inconsistent return types.
type CanvasLocation = List[int] | Tuple[int, ...]
type CellLocation = Tuple[int, int]

# Handling Size
type NumericTypeAlias = int | float | Fraction | Decimal

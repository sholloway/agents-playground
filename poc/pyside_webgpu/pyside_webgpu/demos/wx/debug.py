"""
Create a temporary custom binding for wx to enable debugging.
Copied from wpgu.gui.wx.py
"""

import ctypes

from wgpu.gui.base import WgpuCanvasBase, weakbind
